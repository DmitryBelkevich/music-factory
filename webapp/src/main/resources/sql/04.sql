...
VALUES
    ...
    -- BRUTTO
       (1, 138, -4, NULL), -- 12 обезьян
    -- Lumen
       (1, 84, -2, NULL), -- Гореть
    -- N.R.M.
       (1, 155, -1, NULL), -- Лёгкiя-лёгкiя
       (1, 134, 0, NULL), -- Тры чарапахі
    -- Альянс
       (1, 149, -2, NULL), -- На заре
    -- Агата Кристи
       (1, 54, 0, NULL), -- Как на войне
    -- Аквариум
       (1, 140, 0, NULL), -- Город золотой
    -- Ария
       (1, 95, 1, NULL), -- Закат
    ...
    -- Король и Шут
       ...
       (1, 147, 1, NULL), -- Два монаха в одну ночь
    -- Ленинград
       (1, 111, -3, NULL), -- WWW
    ...
    -- Ляпис Трубецкой
       ...
       (1, 115, 0, NULL), -- Шут
       (1, 136, 3, NULL), -- Манифест
       (1, 137, -2, NULL), -- Танцуй
    -- Михаил Боярский
       (1, 127, -1, NULL), -- Зеленоглазое такси
    -- Михаил Круг
       (1, 105, -3, NULL), -- Кольщик
    -- Мумий Тролль
       (1, 130, 0, NULL), -- Владивосток 2000
       (1, 135, 1, NULL), -- Медведица
    -- Наутилус Помпилиус
       (1, 139, 0, NULL), -- Последнее письмо
    -- Порнофильмы
       (1, 121, 0, NULL), -- Я так соскучился
    -- Сектор Газа
       (1, 133, -2, NULL), -- 30 лет
       (1, 128, -2, NULL), -- Демобилизация
       (1, 131, 0, NULL), -- Пора домой
       (1, 132, -3, NULL), -- Туман
    -- Слот
